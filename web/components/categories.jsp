...
<%! String[] categories = new String[]{"Furniture", "Electronics", "Vehicles", "Fashion", "Books", "Appliances", "Medikits", "Sports"};
    String[] categoryImages = new String[]{"../assets/images/fur/bed/bed3.jpeg", "../assets/images/home/AC/ac1.jpeg", "../assets/images/vehicals/scooty/scooty1.jpeg", "../assets/images/fashion.jpeg", "../assets/images/books.jpg", "../assets/images/appliances.jpg", "../assets/images/medikits.jpeg", "../assets/images/sports.jpg"};
%>
<div class="mt-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-6"> 
        ...
        %>
        <a href="/pages/category.jsp?category=<%= categories[cat]%>">
