...
<html>
    ...
    <body>
        <section class="font-lato">
            ...
            <main class="pt-64 max-w-screen-xl mx-auto min-h-screen">
                <!-- Categories -->
                <jsp:include page="../components/categories.jsp" />
                <!-- Items -->
                <div class="mt-8">
                    <h2 class="text-3xl font-semibold mb-4">Items for Rent</h2>
        ...
        <button class="bg-primary w-36 h-12 text-xl rounded-full m-4 text-white">Load more</button>
            ...
            <footer class="bg-slate-900 text-center text-neutral-100 lg:text-left">
        <div class="flex items-center justify-center border-b border-gray-100/70 p-6 dark:border-neutral-500 lg:justify-between">
          <div class="mr-12 hidden lg:block">
            <span>Get connected with us on social networks:</span>
          </div>
          <!-- Social network icons container -->
          <div class="flex justify-center">
            <a class="mr-6 text-neutral-200">
              <svg
        ...
        <div class="mx-6 py-10 text-center md:text-left">
          <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="">
              ...
              <p class="mb-4">
                <a class=" text-neutral-200">Angular</a>
              </p>
              <p class="mb-4">
                <a class=" text-neutral-200">React</a>
              </p>
              <p class="mb-4">
                <a class=" text-neutral-200">Vue</a>
              </p>
              <p>
                <a class=" text-neutral-200">Laravel</a>
              </p>
            </div>
            ...
            <div class="">
              ...
              <p class="mb-4">
                <a class=" text-neutral-200">Pricing</a>
              </p>
              <p class="mb-4">
                <a class=" text-neutral-200">Settings</a>
              </p>
              <p class="mb-4">
                <a class=" text-neutral-200">Orders</a>
              </p>
              <p>
                <a class=" text-neutral-200">Help</a>
              </p>
            </div>
            <!-- Contact section -->
            <div>
