    ...
    <body>
      ...
      <img src="../assets/images/logo.png" class="h-20" alt="Rentle Logo">
                ...
                <ul class="my-10">
                    ...
                    <li class="pb-8"><a href="userDashboard.jsp?page=support"><i class="fa-solid fa-circle-info mr-4"></i>Help & Support</a></li>
                </ul>
                <button class="" type="submit"><a href="/pages/login.html"><i class="fa-solid fa-right-from-bracket mr-4"></i>Logout</a></button>
            </div>
